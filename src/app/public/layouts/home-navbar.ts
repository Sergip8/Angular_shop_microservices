  ...
  <div class="container mx-auto px-4 py-8 flex items-center  justify-between ">
    ...
    <nav class="contents">
      <ul class="ml-4 xl:w-48 flex items-center justify-end">
        ...
        <li class="ml-2 lg:ml-4 relative inline-block">
          <a class="" href="">
            <div class="absolute -top-2 right-0 z-10 bg-yellow-400 text-xs font-bold px-1 py-0.5 rounded-sm">3</div>
            <div class="w-8">
        ...
        <li class="ml-2 lg:ml-4 relative inline-block">
          <a class="" href="">
            <div class="absolute -top-2 right-0 z-10 bg-yellow-400 text-xs font-bold px-1 py-0.5 rounded-sm">12</div>
            <div class="w-8">
